    ...
    _c(
      ...
      [
        _c("input", {
          ...
          attrs: { type: "text", placeholder: "新しいタスク" },
    ...
    _c(
      "form",
      {
        on: {
          submit: function ($event) {
            $event.preventDefault()
            return _vm.addLabel.apply(null, arguments)
          },
        },
      },
      [
        _c("input", {
          ...
          attrs: { type: "text", placeholder: "新しいラベル" },
...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__["default"]({
  el: '#app',
  components: {
    App: _components_AppComponent_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
